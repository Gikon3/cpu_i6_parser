...
files_in = ["logs_input/session_82_cpu_i6_1_Xe_short.log",
            "logs_input/session_82_cpu_i6_1_Xe.log",
            "logs_input/session_83_cpu_i6_2_Xe_short.log",
            "logs_input/session_83_cpu_i6_2_Xe.log",
            "logs_input/session_84_cpu_i6_3_Xe_short.log",
...
files_excel = ["cosrad_excel/82_2020-3-3_23i16i27.xls",
               "cosrad_excel/82_2020-3-3_23i16i27.xls",
...
base = BaseParser()
alu = AluParser(remove_death_time)
uart = UartParser(remove_death_time)
memory = MemoryParser(remove_death_time)
map = MemoryMap()

with open(number_errors_filename, 'w') as f:
    pass

for file, cosrad_table in zip(files_in, files_excel):
